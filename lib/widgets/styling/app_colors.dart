...
class AppColors {
  ...
  static const Color bgColorDark = Color(0xFF000000);
  ...
  static const Color sapphirePrimaryDark = Color(0xFF4A84E1);
  static const Color sapphirePrimaryLight = Color(0xFF0E2A6B);
  ...
  static const Color bgSurfaceBaseDark = Color(0xFF000000);

  static const Color bgSurfaceSheet = Color(0xFFFFFFFF);
  static const Color bgSurfaceSheetDark = Color(0xFF0E1013);
