...
import 'package:ideal_mobile/presentation/subscription/widgets/subscription_plan_card.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: packages.map((package) {
        final isMonthly = package.identifier.contains(subscriptionMonthly);
        final isSelected =
            selectedPlan != null &&
