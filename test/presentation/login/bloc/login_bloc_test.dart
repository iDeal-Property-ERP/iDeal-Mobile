...
void main() {
  ...
  setUp(() {
    ...
    sl.registerLazySingleton<RequestOtp>(() => mockRequestOtp);
  });
  ...
  group('LoginBloc Phone Number Input', () {
    ...
    blocTest<LoginBloc, LoginState>(
      'should select the SMS OTP channel',
      build: () => LoginBloc(localizations: l10n),
      act: (bloc) => bloc.add(SelectOtpChannelEvent(channel: 'sms')),
      expect: () => [
        isA<LoginState>().having(
          (state) => state.phoneNumberLoginState?.channel,
          'channel',
          'sms',
        ),
      ],
  ...
  group('LoginBloc Phone Number Authentication', () {
    ...
    blocTest<LoginBloc, LoginState>(
      ...
      act: (bloc) => bloc.add(LoginWithPhoneNumEvent('+998901234567')),
      expect: () => [
        isA<PhoneNumLoginLoadingState>().having(
          (state) => state.isLoading,
          'isLoading',
    ...
    blocTest<LoginBloc, LoginState>(
      ...
      act: (bloc) {
        ...
        bloc.add(LoginWithPhoneNumEvent('+998901234567'));
      },
      expect: () => [
